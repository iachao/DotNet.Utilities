...
namespace DotNet.Utilities
{
    ...
    public class HttpItem
    {
        ...
        string _ContentType = "application/x-www-form-urlencoded";//默认提交from表单
        /// <summary>
        ///   /// <summary>
        /// 请求头类型
        ...
        public Version _ProtocolVersion = HttpVersion.Version10;
    ...
    {
       public static string StringContent="application/x-www-form-urlencoded";
       public static string ByteContent = "text/html";
